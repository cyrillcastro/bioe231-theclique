...
- For **MsaView**, there are a few files included in the `data` folder of our repository that can be used for this part of the browser. Once you have those files downloaded to your local, please follow the **"How to View The Data on Jbrowse"** instructions under the **Multiple Sequence Alignment and Phylogenetic Tree Viewing** section. The files that you can view are as follows:
    ...
    - All unzipping commands required for these files are in the `install_scripts/process_data.sh` script
...
The GWAS data in our browser can be found in this compressed file in our repo: `data\filtered_influenzaGWAS.bed.gz`. This .bed file was preprocessed and curated manually by our group, using data from this GWAS study: <a href="https://www.ebi.ac.uk/gwas/studies/GCST003123">https://www.ebi.ac.uk/gwas/studies/GCST003123</a>. All of the commands to process the file and install it to the browser can be found in...
- `install_scripts/process_data.sh` to index the compressed .bed file
- `install_scripts/add_to_jbrowse.sh` to add the compressed .bed file as a track to the hg38 assembly
